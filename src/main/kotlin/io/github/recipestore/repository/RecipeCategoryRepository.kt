...
interface RecipeCategoryRepository: ReactiveCrudRepository<RecipeCategory, Long> {
    ...
    @Modifying
    @Query("UPDATE REPOSITORY.RECIPE_CATEGORY SET NAME=:name, DESCRIPTION=:description, PARENT_CATEGORY_ID=:parentId, USER_ID=:userId, MODIFIED=CURRENT_TIMESTAMP() WHERE RECIPE_CATEGORY_ID=:id")
